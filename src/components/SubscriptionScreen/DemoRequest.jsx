...
const DemoRequests = () => {
  ...
  const { getDemoRequests,loading } = useSubscription();
          ...
          <table className="w-full text-sm">
            ...
            <thead className="bg-gray-100 text-gray-600 uppercase text-xs sticky top-0 z-50">
              <tr>
                ...
                <th className="px-4 py-3 text-left font-semibold text-[12px] uppercase text-[#6B7280] font-inter uppercase">Property</th>
      ...
      <div className="relative mb-4" ref={dropdownRef}>
        ...
        >
          <span className="text-sm">
            {agents.find(a => a.agentId === dropdownValue)?.fullName || "Select Staff"}
          </span>
          {/* <span>▾</span> */}
        ...
        {openDropdown && (
          <div className="absolute mt-2 w-full bg-white rounded-xl shadow-lg border max-h-44 overflow-y-auto z-[9999] text-left">
            ...
            {agents.map((agent) => (
              ...
              >
                {agent.fullName || agent.firstName}
              </div>
            ))}
